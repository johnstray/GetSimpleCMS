    ...
    <main id="maincontent" class="col-lg-9">
        <div class="main">
            ...
            <form id="compEditForm" class="manyinputs watch" action="<?php myself(); ?>" method="post" accept-charset="utf-8" >
                ...
                <div id="submit_line" class="<?php echo $numitems > 0 ? '' : ' hidden'; ?>" >
                    <span><input type="submit" class="btn btn-default-outline submit" name="submitted" id="button" value="<?php i18n('SAVE_SNIPPETS'); ?>" /></span>
                    &nbsp;&nbsp;<?php i18n('OR'); ?>&nbsp;&nbsp; <a class="cancel" href="snippets.php?cancel"><?php i18n('CANCEL'); ?></a>
                </div>
            </form>
