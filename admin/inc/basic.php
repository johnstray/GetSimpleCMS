...
class SimpleXMLExtended extends SimpleXMLElement
{
     ...
     * @param string $cdata_text value to add as cdata
     */
     ...
     *
     * @uses   dom_import_simplexml
     * @param  string $cdata_text value to insert as cdata
     * @return object             node
     */
     ...
     * @param string $value    teh new node value
     */
     ...
     * get the nodes type
     *
     * @return string returns the nodetype constant of node
 ...
 *
 * @since  3.4
 * @param  string $filepath filepath to data file
 * @return bool status
 */
 ...
 * @return string            permalink string
 */
 ...
 * @return string js array string syntax
 */
 ...
 *
 * @since  3.4
 * @return string path to script filename
 */
 ...
 *
 * @since  3.4
 * @return stringdate format string
 */
 ...
 *
 * @since  3.4
 * @return stringdate time format string
 */
 ...
 *
 * @since  3.4
 * @param  string $locale a csv locale str
 * @return stringset locale, false on fail
 */
 ...
 *
 * @since  3.4
 * @return stringstring with height units
 */
 ...
 *
 * @since  3.4
 * @return stringvalid js nested array ([[ ]]) or escaped toolbar id ('toolbar_id')
 */
 ...
 *
 * @since  3.4
 * @return stringtimezone identifier
 */
 ...
 *
 * @since 3.4
 * @param stringtimezone identifier http://us3.php.net/manual/en/timezones.php
 */
 ...
 * @return string          output of function output buffer
 */
...
if (!function_exists('array_column')) {
     ...
     *                          the returned array. This value may be the integer
     *                          key of the column, or it may be the string key
     *                          name.
     * @return array
     */
