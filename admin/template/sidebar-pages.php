...
<ul class="snav">
    <li id="sb_pages" >
        <a href="pages.php"
            accesskey="<?php echo find_accesskey(i18n_r('SIDE_VIEW_PAGES'));?>" <?php check_menu('pages');  ?>>
            <?php i18n('SIDE_VIEW_PAGES'); ?>
        </a>
    </li>
    <li id="sb_newpage" >
        <a href="edit.php"
            accesskey="<?php echo find_accesskey(i18n_r('SIDE_CREATE_NEW'));?>"
            <?php if ((!isset($_GET['id'])) && isPage('edit')) {
                echo 'class="current"';
            } ?>>
    ...
    <?php if ((isset($_GET['id']) && $_GET['id'] != '') && isPage('edit')) { ?>
        <li id="sb_pageedit" ><a href="#" class="current"><?php i18n('EDITPAGE_TITLE'); ?></a></li>
    <?php } ?>
    <li id="sb_menumanager" class="last_sb">
        <a href="menu-manager.php"
            accesskey="<?php echo find_accesskey(i18n_r('MENU_MANAGER'));?>" <?php check_menu('menu-manager');  ?>>
